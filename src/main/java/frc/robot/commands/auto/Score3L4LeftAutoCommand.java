...
public class Score3L4LeftAutoCommand extends BaseAutoCommand {
  ...
  public Score3L4LeftAutoCommand(
    ...
    addCommands(scoreL4CoralAndIntakeTo(PRE_SCORE_LEFT_4, blueLeftOuterStationFromFar, 3));

    addCommands(scoreL4CoralAndIntakeThrough(PRE_SCORE_LEFT_2, blueLeftOuterStation, 1.5));

    addCommands(scoreL4CoralAndIntakeThrough(PRE_SCORE_LEFT_3, blueLeftOuterStation, 1.5));
  }
}
